...
# 1 介绍数据集 
CPSC2021 全称是 第十届生物医学工程与生物技术国际会议(ICBEB 2021)）。数据集分两个阶段。第一个阶段采集有 49 名被采集者的心电信号。第二个阶段采集有 37 名被采集者的心电信号。一共有 1460 条心电信号。每条信号 1-30 分钟。数据集中有对 房颤(  "(AFIB"  、 "(AFL"  )  正常 ( "(N" )   三种类型的心拍类型标注。
